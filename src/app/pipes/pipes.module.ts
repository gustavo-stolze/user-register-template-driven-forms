...
@NgModule({
  declarations: [GenreDescriptionPipe, StateDescriptionPipe, IsFavoriteDescriptionPipe],
  exports: [GenreDescriptionPipe, StateDescriptionPipe, IsFavoriteDescriptionPipe],
})
